...
export default function Wheels() {
  return (
    <><div className="App">
      <Header />
      <h2 class="head">Wheels - Shop by Brand</h2>
      <br></br>
        ...
        <br></br>
        <h2 class="head">Wheel House</h2>
        <br></br>
        <p class="category-desciption">
            CarHub understands that every part you purchase for your vehicle not only has 
            a function, but makes a statement. The wheels you choose tell your cars story, whether 
            it’s a Mitsubishi Evo, Subaru WRX, Honda Civic or otherwise we’ve got wheels that will give 
            you that perfect look and performance you’ve been searching for.
            <br></br>
            From lightweight wheels to shave off a few pounds of rotational weight to the deep dish, perfectly 
            tucked wheels that turn heads. From Black to Chrome and everything in between. CarHub 
            is ready to help you find exactly what you need to get that perfect look.
        </p>
        <Footer />
      </div></>
  );
